...
APPLICATION_NAME="TrollBoard Reborn"
rm -rf build
mkdir build
...
mkdir Payload
cp -r TrollBoard\ Reborn.app Payload/TrollBoard\ Reborn.app
zip -vr TrollBoard\ Reborn.ipa Payload
rm -rf TrollBoard\ Reborn.app
rm -rf DerivedDataApp
rm -rf Payload
zip -vr share.zip TrollBoard\ Reborn.ipa
